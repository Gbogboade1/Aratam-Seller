              ...
              child: Column(
                children: [
                        ...
                        child: ListView(
                          ...
                          children: [
                            OrderTypeButton(
                              ...
                              orderList: orderProvider.orderList, callback: callback,
                            ),
                            OrderTypeButton(
                  ...
                  Consumer<ProfileProvider>(
                    builder: (context, seller, child) =>  seller.userInfoModel !=null ? SizedBox(
                        height: 120,
                        child: ListView(
                          scrollDirection: Axis.horizontal,
                          ...
                          children: [
                            Container(
                              ...
                              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(getTranslated('balance_withdraw', context), style: titilliumBold.copyWith(color: ColorResources.WHITE, fontSize: Dimensions.FONT_SIZE_LARGE), textAlign: TextAlign.start),
                                  Text(PriceConverter.convertPrice(context, seller.userInfoModel.wallet != null ? seller.userInfoModel.wallet.balance ?? 0 : 0),
                                      style: titilliumBold.copyWith(color: ColorResources.WHITE, fontSize: Dimensions.FONT_SIZE_LARGE), textAlign: TextAlign.start),
                                  Align(
                                      alignment: Alignment.bottomRight,
                                      child: InkWell(
                                        onTap: () => showCupertinoModalPopup(context: context, barrierDismissible: false, builder: (_) => CustomEditDialog()),
                                        child: Container(
                                            ...
                                            child: Text(getTranslated('withdraw', context), style: titilliumSemiBold.copyWith(fontSize: Dimensions.PADDING_SIZE_DEFAULT, color: Theme.of(context).primaryColor))
                                        ),
                                      ),
                                  )
                                ],
                            ...
                            Container(
                              ...
                              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(getTranslated('withdrawn', context), style: titilliumBold.copyWith(color: ColorResources.WHITE, fontSize: Dimensions.FONT_SIZE_LARGE), textAlign: TextAlign.start),
                            ...
                            Container(
                              ...
                              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(getTranslated('total_earning', context), style: titilliumBold.copyWith(color: ColorResources.WHITE, fontSize: Dimensions.FONT_SIZE_LARGE), textAlign: TextAlign.start),
                                  Text(PriceConverter.convertPrice(context, seller.userInfoModel.wallet != null ? seller.userInfoModel.wallet.balance+seller.userInfoModel.wallet.withdrawn : 0),
                                      style: titilliumBold.copyWith(color: ColorResources.WHITE, fontSize: Dimensions.FONT_SIZE_LARGE), textAlign: TextAlign.start),
                                ],
                              ),
                            ),
                  ...
                  Padding(padding: EdgeInsets.all(10),
                      ...
                      child: Consumer<BankInfoProvider>(builder: (context, bankInfo, child) {
                        ...
                        return EarningChart(earnings: _earnings, max: _max);
                      }),
                  ),
